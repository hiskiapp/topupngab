...
<div class="card card-custom">
    <div class="card-header">
        <div class="card-title">
            ...
            <h3 class="card-label">Game List</h3>
        </div>
...
<script>
    ...
    var KTDatatablesDataSourceAjaxServer = function () {
        ...
        var table = $('#kt_datatable').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: `${HOST_URL}/data/games`,
                type: 'POST',
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                },
                data: {
                    columnsDef: ['iteration', 'code', 'name', 'unit', 'updated_at', 'id'],
                },
            },
            columns: [{
                data: 'iteration'
            ...
            columnDefs: [{
                ...
                render: function (data, type, full, meta) {
                    return `<a href="${HOST_URL}/games/${data}/edit" class="btn btn-sm btn-default btn-text-primary btn-hover-primary btn-icon mr-2" title="Edit details">\
                        <span class="svg-icon svg-icon-md">\
                    ...
                    <a href="${HOST_URL}/games/${data}" class="btn btn-sm btn-default btn-text-primary btn-hover-primary btn-icon mr-2" title="Show details">\
                        <span class="svg-icon svg-icon-md">\
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">\
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">\
                                    <rect x="0" y="0" width="24" height="24"/>\
