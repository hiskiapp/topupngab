...
<div class="card card-custom card-sticky" id="kt_page_sticky_card">
    ...
    <div class="card-body">
        <!--begin::Form-->
        <form class="form" id="kt_form" method="POST" action="{{ route('games.store') }}">
            @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <input class="form-control form-control-solid @error('code') is-invalid @enderror"
                                    type="text" name="code" value="{{ old('code') }}" required autocomplete="off"
                                    placeholder="Code (ex: ff)" />
                                @error('code')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <input class="form-control form-control-solid @error('unit') is-invalid @enderror"
                                    type="text" name="unit" value="{{ old('unit') }}" required autocomplete="off"
                                    placeholder="Unit (ex: DM)" />
                                @error('unit')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                                ...
                                <div data-repeater-list="items" class="col-lg-9">
                                    ...
                                    <div data-repeater-item class="form-group row align-items-center">
                                        <div class="col-md-5">
                                            ...
                                            <input type="text" name="amount"
                                                value="{{ old('items.'.$loop->index.'.amount') }}"
                                        ...
                                        <div class="col-md-5">
                                            ...
                                            <input type="text" name="price"
                                                value="{{ old('items.'.$loop->index.'.price') }}"
                                    ...
                                    <div data-repeater-item class="form-group row align-items-center">
                                        <div class="col-md-5">
                                            <label>Amount:</label>
                                            <input type="text" name="amount"
                                                class="form-control form-control-solid number-format"
                                                placeholder="Enter amount item" required />
                                            <div class="d-md-none mb-2"></div>
                                        </div>
                                        <div class="col-md-5">
